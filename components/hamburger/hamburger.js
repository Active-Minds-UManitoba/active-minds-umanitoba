document.querySelector(".navbar-container").innerHTML = `<div class="navbar">
                    <div class="navbar__logo">
                        <img src="../club Assets/activeMindsLogo.png" alt="logo">
                    </div>
                    <div class="menu-container">
                        <div id="menu-bar" onclick="menuOnClick()">
                            <div id="bar1" class="bar change"></div>
                            <div id="bar2" class="bar change"></div>
                            <div id="bar3" class="bar change"></div>
                        </div>
...
.navbar__menu-item a:hover {
    color: #ff6347; /* Example color for hover */
